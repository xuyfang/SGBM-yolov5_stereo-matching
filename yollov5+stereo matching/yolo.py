...
class YOLO(object):
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        for i, c in list(enumerate(top_label)):
            ...
            # print('\n像素坐标 x = %d' % (middle_x, middle_y))
            print("\n像素坐标 x = (", middle_x, ",", middle_y, ")")
            print("世界坐标xyz是：", threeD[middle_y][middle_x][0] / 1000.0, threeD[middle_y][middle_x][1] / 1000.0,
                  threeD[middle_y][middle_x][2] / 1000.0, "m")
            distance = math.sqrt(
                threeD[middle_y][middle_x][0] ** 2 + threeD[middle_y][middle_x][1] ** 2 + threeD[middle_y][middle_x][2] ** 2)
            distance = distance / 1000.0
            print("距离是：", distance, "m")
            #--------------------------------------------------------------------#
            label = '{} {:.2f} dis={:.2f}'.format(predicted_class, score, distance)
